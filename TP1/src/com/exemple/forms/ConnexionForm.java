...
public final class ConnexionForm {
    ...
    public Utilisateur connecterUtilisateur( HttpServletRequest request ) {
        ...
        if ( erreurs.isEmpty() && UtilisateurDAO.isValidLogin( email, motDePasse ) ) {
            utilisateur = UtilisateurDAO.getUtilisateur(email);
        	resultat = "Succès de la connexion.";
            System.out.println( utilisateur );
        } else {
        	//setErreur( CHAMP_PASS, "mot de passe n'est pas correct!" );
    ...
    private void validationMotDePasse( String email, String motDePasse ) throws Exception {
        if ( motDePasse != null ) {
            ...
            }else if(!UtilisateurDAO.isValidLogin( email, motDePasse )) {
